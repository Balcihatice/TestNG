...
//    Exceldeki verileri Test sinifinda kullanmak icin bu metotu kullanacaz
    ...
    public List<String> getColumnsNames() {
        ...
        for (Cell cell : workSheet.getRow(0)) {
            columns.add(cell.toString());//ilk satirdaki sutun isimlerini tek tek ekliyor
        }
        return columns;
    }

    //=========When you enter the row and column number, returning the value===============//
    //=========Deger , Satir ,  Sutun girildiginde o satir ve sutuna girilen veriyi ekler. index kabul eder
    ...
    //Yukaridaki methodla birlikte calisir, Override eder. Parametreleri farklidir.
